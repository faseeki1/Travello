...
<div class="super_container">
	...
	<div class="destinations" id="destinations" style="margin-top: 10rem;">
		<div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2>Oooops, Sorry the page you are looking for is unavailable.</h2>
                    <a href="index.php" class="btn btn-md login text-white"><i class="fa fa-chevron-left"></i> Go back home</a>
                </div>
            </div>
        </div>
	</div>
