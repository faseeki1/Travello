<?php include "include/db.php"; ob_start();?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>Contact</title>
			...
			<div class="row">
				<?php
					if(isset($_POST["submit"])){
						...
						$monthname = array("01"=>"January","02"=>"Febuary","03"=>"March","04"=>"April","05"=>"May","06"=>"June","07"=>"July","08"=>"August","09"=>"Septemper","10"=>"October","11"=>"November","12"=>"December"); 
						$month = $monthname["$m"];
						$year = 20 .date("y");
						$date = $day .$sfx ." of " .$month ." " .$year;
						$check_db = mysqli_query($connect,"SELECT * FROM messages WHERE name ='$name' AND email = '$email' AND message='$message'");
						if(mysqli_num_rows($check_db) == 0){
							$send_db = mysqli_query($connect,"INSERT INTO messages(name,email,subject,message,time,date) VALUES('$name','$email','$subject','$message',$time,'$date')");
							if($send_db){
								echo "<div class='col-lg-12 alert alert-success'><h4> Your message was sent successfully. We'll get back to you as soon as we can. Thank you for contacting us. <i class='fa fa-thumbs-up'></i> </h4></div>";
							}else{
				...
				<div class="col-lg-6">
					<div class="contact_form_container">
						<form action="" method="post" id="contact_form" class="contact_form">
							<div style="margin-bottom: 18px"><input type="text" name="name" class="contact_input contact_input_name inpt" placeholder="Your Name" required="required"><div class="input_border"></div></div>
							<div class="row">
								<div class="col-lg-6" style="margin-bottom: 18px">
									<div><input type="email" name="email" class="contact_input contact_input_email inpt" placeholder="Your E-mail" required="required"><div class="input_border"></div></div>
								</div>
								<div class="col-lg-6" style="margin-bottom: 18px">
									<div><input type="text" name="subject" class="contact_input contact_input_subject inpt" placeholder="Subject" required="required"><div class="input_border"></div></div>
								</div>
							</div>
							...
							<input type="submit" name="submit" value="Send Message" class="contact_button" >
						</form>
					</div>
				</div>
			</div>
